  ...
  methods: {
    ...
    renderBg(data) {
      ...
      const panelTheme = darkBackground ? {
        // Dark canvas: lift cards with blue-gray glass instead of a white slab.
        '--k-panel-bg': 'rgba(35, 49, 68, .9)',
        '--k-panel-bg-2': 'rgba(8, 18, 31, .32)',
        '--k-panel-hover': 'rgba(46, 64, 87, .96)',
        '--k-panel-border': 'rgba(147, 187, 218, .2)',
        '--k-panel-border-subtle': 'rgba(210, 228, 242, .11)',
        '--k-panel-text': '#f1f5f9',
        '--k-panel-text-2': 'rgba(226, 235, 243, .76)',
        '--k-panel-text-3': 'rgba(210, 222, 233, .54)',
        '--k-panel-progress': 'rgba(196, 216, 232, .15)',
        '--k-panel-accent': '#5ab9d8',
        '--k-panel-cpu': '#65bfdc',
        '--k-panel-memory': '#a58ae3',
        '--k-panel-disk': '#e0aa58',
        '--k-panel-load': '#df83ad',
        '--k-panel-up': '#5ab9d8',
        '--k-panel-down': '#64b987',
        '--k-panel-online': '#59bc84',
        '--k-panel-offline': '#df7782',
        '--k-panel-warn': '#dda951',
        '--k-panel-price-fg': '#e2b55f',
        '--k-panel-tag-fg': '#72c6df',
        '--k-panel-lat-1': '#59bc84',
        '--k-panel-lat-2': '#a9ca67',
        '--k-panel-lat-3': '#ddbd5b',
        '--k-panel-lat-4': '#de9258',
        '--k-panel-lat-5': '#df7782',
        ...
        '--k-shell-border': 'rgba(255, 255, 255, .07)',
        '--k-shell-divider': 'rgba(255, 255, 255, .13)',
