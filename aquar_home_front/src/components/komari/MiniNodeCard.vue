...
.k-mini-head { display: flex; align-items: center; gap: 7px; min-width: 0; }.k-mini-name { flex: 1; min-width: 0; overflow: hidden; font-size: 13px; font-weight: 800; text-overflow: ellipsis; white-space: nowrap; }
