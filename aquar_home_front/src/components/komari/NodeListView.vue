...
.k-list-head { border-bottom: 1px solid var(--k-border-subtle); color: var(--k-text-3); font-size: 11px; font-weight: 800; letter-spacing: .04em; }.k-list-row { border-bottom: 1px solid var(--k-border-subtle); font-size: 13px; transition: background .18s ease; }.k-list-row:last-child { border-bottom: 0; }.k-list-row:hover { background: var(--k-surface-2); }.k-list-row.offline { opacity: .62; }
